    ...
    <div class="max-w-md w-full space-y-8">
        <div class="text-center">
            ...
            <p class="mt-2 text-sm text-gray-600">
                Join UrPearl SHOP and start shopping today
            </p>
        </div>
        ...
        <div class="mt-8 space-y-6">
            ...
            <div class="bg-white rounded-2xl shadow-xl p-8">
                ...
                <form action="{{ route('register.perform') }}" method="POST" class="space-y-6">
                    ...
                    <div>
                        <button type="submit" class="w-full flex justify-center py-3 px-4 border border-transparent rounded-xl shadow-sm text-sm font-medium text-white bg-pink-600 hover:bg-pink-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-pink-500 transition-colors">
                            Create Account
                        </button>
                    </div>
                </form>
