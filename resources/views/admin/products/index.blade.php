                        ...
                        @foreach($products as $product)
                            <tr class="hover:bg-gray-50">
                                ...
                                <td class="px-3 py-2 whitespace-nowrap">
                                    <div class="flex items-center">
                                        ...
                                        <div>
                                            ...
                                            <div class="text-xs text-gray-500">{{ $product->size_name }}</div>
                                            <div class="flex flex-wrap gap-1 mt-1">
                                                @if($product->is_new_arrival)
                                                    <span class="inline-flex items-center px-1.5 py-0.5 rounded text-[10px] font-medium bg-pink-100 text-pink-800">
                                                        New
                                                    </span>
                                                @endif
                                ...
                                <td class="px-3 py-2 whitespace-nowrap">
                                    ...
                                    @endphp
                                    <span class="inline-flex px-2 py-0.5 text-[11px] font-semibold rounded-full {{ $statusClasses[$stockStatus] ?? 'bg-gray-100 text-gray-800' }}">
                                        {{ $statusLabels[$stockStatus] ?? 'Unknown' }}
                                    </span>
                                </td>
                                <td class="px-3 py-2 whitespace-nowrap text-sm font-medium space-x-2">
                                    <a href="{{ route('admin.products.show', $product) }}" class="text-indigo-600 hover:text-indigo-900" title="View">
                                        <svg class="w-4 h-4 inline" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"></path>
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z"></path>
                                        </svg>
                                    </a>
                                    <a href="{{ route('admin.products.edit', $product) }}" class="text-pink-600 hover:text-pink-900" title="Edit">
                                        <svg class="w-4 h-4 inline" fill="none" stroke="currentColor" viewBox="0 0 24 24">
